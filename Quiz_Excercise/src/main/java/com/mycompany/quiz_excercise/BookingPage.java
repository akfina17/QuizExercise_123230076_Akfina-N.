...
class BookingPage extends JFrame {
    ...
    JLabel lengthLabel = new JLabel("Total nights: ");
    JTextField lengthField = new JTextField();
    JLabel guestLabel = new JLabel("Total Guests: ");
    ...
    private void processBooking() {
        try {
            ...
            FileBooking.TulisFile(name + "," + nights + "," + totalCost, "databooking.txt");
            FileBooking.BacaFile("databooking.txt");
            System.out.println(FileBooking.BacaFile("databooking.txt"));
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(this, "Please input a valid number for nights", "Error", JOptionPane.ERROR_MESSAGE);
        } catch (Exception e) {
